          ...
          <div className="bussiness-card-content">
            <div className="bussiness-card mr-94">
              <div className="bussiness-card-detail">
                ...
                <h2>ARCHITECTURE</h2>
                <p>
                  What Is CurrikiStudio?<br/> How Does it Work?<br/>  How is Content Created
            ...
            <div className="bussiness-card mr-94">
              <div className="bussiness-card-detail">
                  ...
                  <p>
                    What is Curriki’s Major Schemas?<br/>  Sub schemas:<br/>  Authoring Flow,
            ...
            <div className="bussiness-card">
              <div className="bussiness-card-detail">
                ...
                <h2>DEPLOYMENT</h2>
                <p>
                  What is CurrikiStudio’s Topology?<br/>  How Can I Deploy the Platform?
